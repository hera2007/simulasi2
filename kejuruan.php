    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-4 col-md-6" id="jurusan-tkj">
        <div class="card shadow rounded m-3 p-4 d-flex align-items-center text-center">
          <img src="galeri/tkj.png" alt="TKJ" class="img-fluid" style="max-height: 120px;" />
          <div class="card-body">
      ...
      <div class="col-lg-4 col-md-6" id="jurusan-pplg">
        <div class="card shadow rounded m-3 p-4 d-flex align-items-center text-center">
          <img src="galeri/pplg.png" alt="PPLG" class="img-fluid" style="max-height: 120px;" />
          <div class="card-body">
      ...
      <div class="col-lg-4 col-md-6" id="jurusan-tsm">
        <div class="card shadow rounded m-3 p-4 d-flex align-items-center text-center">
          <img src="galeri/tbsm..png" alt="tbSM" class="img-fluid" style="max-height: 120px;" />
          <div class="card-body">
      ...
      <div class="col-lg-4 col-md-6" id="jurusan-dkv">
        <div class="card shadow rounded m-3 p-4 d-flex align-items-center text-center">
          <img src="galeri/dkv.png" alt="DKV" class="img-fluid" style="max-height: 120px;" />
          <div class="card-body">
      ...
      <div class="col-lg-4 col-md-6" id="jurusan-toi">
        <div class="card shadow rounded m-3 p-4 d-flex align-items-center text-center">
          <img src="galeri/TOI.png" alt="TOI" class="img-fluid" style="max-height: 120px;" />
          <div class="card-body">
